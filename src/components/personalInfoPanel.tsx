...
function PersonalInfoPanel() {
  return (
    <div className="h-full min-h-screen text-personal-info-text flex flex-col items-center">
      <div className="self-center mt-[30px] xl:mt-20">
        <img
          src="images/profile_pic.JPG"
          alt="Profile Picture"
          className="w-[180px] h-[180px] xl:w-[250px] xl:h-[250px] rounded-full object-cover object-center"
        />
      </div>
      <div>
        <p className="font-bold text-[26px] mt-[30px] xl:text-[28px] xl:mt-10">
          Carmen Chan
        </p>
        <div className="flex flex-row justify-center">
          ...
          <div className="ml-[50px] xl:ml-[30px]">
      ...
      <div className="text-center mt-[30px] text-[16px] xl:mt-[50px] xl:text-[18px] pt-[10px] h-[225px] xl:h-auto">
        <p>HTML | CSS | SCSS | JavaScript | ReactJS | jQuery</p>
        <p>PHP | Laravel | SQL</p>
        <p>Android Apps Development (Java)</p>
      </div>
      <div className="text-[rgb(151,151,151)] text-[12px] xl:text-[14px] absolute bottom-[30px]">
        <ProjectCopyright />
      </div>
    </div>
  )
